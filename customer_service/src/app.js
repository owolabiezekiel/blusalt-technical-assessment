...
(0, typeorm_1.createConnection)()
    ...
    amqp.connect("amqps://urpyormt:kZSThtc9hilGyHDyobXuSxRQ12i7aP7K@beaver.rmq.cloudamqp.com/urpyormt", function (connectError, connection) {
        ...
        connection.createChannel(function (createChannelError, channel) {
            ...
            app.get("/customer/getcustomer", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                var customer;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, customerRepository.findOne(req.body.id)];
                        case 1:
                            customer = _a.sent();
                            res.json(customer);
                            return [2 /*return*/];
            ...
            app.get("/customer/getcustomers", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                var customer;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, customerRepository.find()];
                        case 1:
                            customer = _a.sent();
                            res.json(customer);
                            return [2 /*return*/];
